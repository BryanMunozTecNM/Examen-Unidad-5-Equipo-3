...
<body>
    ...
    <h1 class="h1 text-center">Padres</h1>
    <!--  contenedor div para el formulario y establece su estilo como "display: none;" para ocultarlo inicialmente:-->
    <div id="formularioPadre" method="POST" style="display: none;">
        <!-- formulario mando datos a archivo php -->
        <form action="insertar_padre.php" method="POST" onsubmit="return validarFormulario()">
            <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#formularioPadre').submit(function(e) {
                if ($('#nombres').val() == '') {
    ...
    <!-- modifica  botón "Agregar padre" para que al hacer clic se muestre el formulario-->
    ...
    <script>
        function mostrarFormulario() {
            ...
            var botonAgregarPadre = document.querySelector('.btn.btn-primary.btn-lg.btn-block');
            botonAgregarPadre.style.display = "none";
        }
    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        <tbody>
            ...
            function generarTablaPadres($conn)
            {
                $output = "<thead>"; // Comienzo de la tabla

                $sql = "SELECT ID, Nombres, Apellidos, Telefono FROM padres";
                ...
                while ($row = $resultado->fetch()) {
                    ...
                    $output .= "<td>" . " <a href='niños.php?id=". $row['ID']. "' class='btn btn-outline-info'><i class='fas fa-eye'></i><b>INFO</b> ℹ️</a></td>";
                    $output .= "<td>" . "<a href='update_padre.php?id=". $row['ID']. "' class='btn btn-outline-warning'><i class='fas fa-edit'></i><b>Editar</b> ✏️</a></td>";
                    $output .= "<td>" . "<a href='delete_padre.php?id=". $row['ID']. "' class='btn btn-outline-danger'><i class='fas fa-trash-alt'></i><b>Eliminar</b> 🗑️</a></td>";
                    $output .= "</tr>";
                }
